...
#
# This is a pruned copy carrying only the helpers that
# `training_engine_tensor.ops.attention.fa4_cute` depends on; it is *not*
# the full upstream package. See NOTICE.md in this directory for the
# upstream provenance and license placeholder.
