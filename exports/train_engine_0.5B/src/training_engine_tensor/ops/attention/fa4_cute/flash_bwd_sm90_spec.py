"""SM90 FlashAttention bwd — dense causal GQA spec: no varlen/sparse/flex, fixed 128/128/2-stage."""
import math
...
from . import utils
from .mask_spec import AttentionMaskBwdCausal
...
# --- Fixed production spec (GQA 8:1, D=64, causal) ---
_SPEC_HEAD = 64
_SPEC_TILE_MN = 128
_SPEC_Q = _SPEC_dO = _SPEC_PdS = 2
_SPEC_SdP_swapAB = True
_SPEC_dKV_swapAB = False
_SPEC_dQ_swapAB = False
_SPEC_Atom_M = 1
_SPEC_Atom_N = 2
_SPEC_Atom_dQ = 2
_SPEC_NUM_THREADS = 384
_SPEC_QH_PER_KVH = 8
_SPEC_SOFTMAX_LINEAR = 1.0 / math.sqrt(_SPEC_HEAD)


class FlashAttentionBackwardSm90Spec:
    arch = 90
    ...
    def __init__(
        ...
        self.qhead_per_kvhead = _SPEC_QH_PER_KVH
        self.is_causal = True
        self.is_local = False
        self.tile_m = _SPEC_TILE_MN
        self.tile_n = _SPEC_TILE_MN
        self.num_threads = _SPEC_NUM_THREADS
        self.Q_stage = _SPEC_Q
        self.dO_stage = _SPEC_dO
        self.PdS_stage = _SPEC_PdS
        self.SdP_swapAB = _SPEC_SdP_swapAB
        self.dKV_swapAB = _SPEC_dKV_swapAB
        self.dQ_swapAB = _SPEC_dQ_swapAB
        self.AtomLayoutMSdP = _SPEC_Atom_M
        self.AtomLayoutNdKV = _SPEC_Atom_N
        self.AtomLayoutMdQ = _SPEC_Atom_dQ
        self.num_wg_mma = (self.num_threads // 128) - 1
        self.mma_dkv_is_rs = (
            _SPEC_Atom_M == 1
            and _SPEC_Atom_N == self.num_wg_mma
            and _SPEC_SdP_swapAB
            and not _SPEC_dKV_swapAB
        )
        assert self.qhead_per_kvhead > 1
        assert self.num_wg_mma == 2, "GQA spec assumes 2 MMA warp groups"
        ...
        self.score_mod = None
        self.score_mod_bwd = None
        self.mask_mod = None
        self.has_aux_tensors = False
    ...
    def __call__(
        ...
        _unused_blocksparse: Optional[object] = None,
    ...
    def kernel(
        ...
        blocksparse_tensors: Optional[object] = None,
    ...
    def dQaccum_store(
        ...
        while work_tile.is_valid_tile:
            ...
            # For local masking + deterministic (non-spt)
