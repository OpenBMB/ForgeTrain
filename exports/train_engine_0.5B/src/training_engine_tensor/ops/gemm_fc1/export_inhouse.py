"""AOT C-export for in-house persistent GEMM kernel — fc1 fwd/dgrad.
...
def get_export_dir():
    return os.path.join(os.environ.get("CUTEDSL_CACHE_ROOT", "/tmp"), "inhouse_aot_fc1")
...
def main():
    ...
    compile_and_export("inhouse_fc1_fwd",
        M=40960, N=8192, K=1024, a_major="k", b_major="k", c_major="n",
        c_dtype=cutlass.BFloat16, cfg=PERSISTENT_CONFIGS["fc1_fwd"], export_dir=export_dir)

    compile_and_export("inhouse_fc1_dgrad",
        M=40960, N=1024, K=8192, a_major="k", b_major="n", c_major="n",
        c_dtype=cutlass.BFloat16, cfg=PERSISTENT_CONFIGS["fc1_dgrad"], export_dir=export_dir)

    compile_and_export("inhouse_fc1_wgrad",
        M=8192, N=1024, K=40960, a_major="m", b_major="n", c_major="n",
        c_dtype=cutlass.Float32, cfg=PERSISTENT_CONFIGS["fc1_wgrad"],
        export_dir=export_dir)

    print(f"\n=== fc1 inhouse export done → {export_dir} ===")
