"""AOT C-export for in-house persistent GEMM kernel — fc2 fwd/dgrad.
...
def get_export_dir():
    return os.path.join(os.environ.get("CUTEDSL_CACHE_ROOT", "/tmp"), "inhouse_aot_fc2")
...
def main():
    ...
    compile_and_export("inhouse_fc2_fwd",
        M=40960, N=1024, K=4096, a_major="k", b_major="k", c_major="n",
        c_dtype=cutlass.BFloat16, cfg=PERSISTENT_CONFIGS["fc2_fwd"], export_dir=export_dir)

    compile_and_export("inhouse_fc2_dgrad",
        M=40960, N=4096, K=1024, a_major="k", b_major="n", c_major="n",
        c_dtype=cutlass.BFloat16, cfg=PERSISTENT_CONFIGS["fc2_dgrad"], export_dir=export_dir)

    compile_and_export("inhouse_fc2_wgrad",
        M=1024, N=4096, K=40960, a_major="m", b_major="n", c_major="n",
        c_dtype=cutlass.Float32, cfg=PERSISTENT_CONFIGS["fc2_wgrad"],
        export_dir=export_dir)

    print(f"\n=== fc2 inhouse export done → {export_dir} ===")
